...
if __name__ == "__main__":
    # st.header("Quizzify") -- 2 header so commented 1

    # Configuration for EmbeddingClient
    embed_config = {
        "model_name": "textembedding-gecko@003",
        "project": "sample-mission-427423",
    ...
    # Step 1: Initialize DocumentProcessor and Ingest Documents
    processor = DocumentProcessor()
    processor.ingest_documents()

    # Step 2: Initialize the EmbeddingClient
    embed_client = EmbeddingClient(**embed_config)

    # Step 3: Initialize the ChromaCollectionCreator
    ...
    with screen.container():
        ...
        with st.form("Load Data to Chroma"):
            ...
            # Step 4: Use Streamlit widgets to capture the user's input
            ...
            if submitted:
                ...
                # Step 5: Create a Chroma collection from the processed documents
