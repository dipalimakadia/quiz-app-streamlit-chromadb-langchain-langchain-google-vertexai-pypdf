...
#         context_docs = retriever.get_relevant_documents(self.topic)
...
#         prompt_template = PromptTemplate.from_template(self.system_template)
#         prompt = prompt_template.format(topic=self.topic, context=context)
        
#         generated_question = self.llm.predict(prompt)
#         st.write("Generated Question with Context")
#         st.text(generated_question)
